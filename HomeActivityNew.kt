...
class MainActivity : AppCompatActivity() {
    ...
    val url="https://www.coinbase.com/dashboard"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Toast.makeText(getApplicationContext(), "MainActivity.kt", Toast.LENGTH_LONG).show()
        ...
        contactsButton.setOnClickListener { startActivity(Intent(this, ContactsActivity::class.java)) }
